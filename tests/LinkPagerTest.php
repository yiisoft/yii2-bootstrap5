...
class LinkPagerTest extends TestCase
{
    public function testFirstLastPageLabels()
    {
        ...
        $this->assertStringContainsString(
            '<li class="page-item first"><a class="page-link" href="/?r=test&amp;page=1" data-page="0">1</a></li>',
            $output,
        );
        $this->assertStringContainsString(
            '<li class="page-item last"><a class="page-link" href="/?r=test&amp;page=25" data-page="24">25</a></li>',
            $output,
        );
        $output = LinkPager::widget([
            'pagination' => $pagination,
        ...
        $this->assertStringContainsString(
            '<li class="page-item first"><a class="page-link" href="/?r=test&amp;page=1" data-page="0">First</a></li>',
            $output,
        );
        $this->assertStringContainsString(
            '<li class="page-item last"><a class="page-link" href="/?r=test&amp;page=25" data-page="24">Last</a></li>',
            $output,
        );
        $output = LinkPager::widget([
            'pagination' => $pagination,
    ...
    public function testDisableCurrentPageButton()
    {
        ...
        $this->assertStringContainsString(
            '<li class="page-item active" aria-current="page"><a class="page-link" href="/?r=test&amp;page=6" data-page="5">6</a></li>',
            $output,
        );
        $output = LinkPager::widget([
            'pagination' => $pagination,
        ...
        $this->assertStringContainsString(
            '<li class="page-item active disabled" aria-current="page"><a class="page-link" href="/?r=test&amp;page=6" data-page="5" tabindex="-1">6</a></li>',
            $output,
        );
    }
